    ...
    <div class="card-body">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-ventas-tab" data-bs-toggle="tab" data-bs-target="#nav-ventas" type="button" role="tab" aria-controls="nav-ventas" aria-selected="true">Ventass</button>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select id="vende" class="form-control">
                                ...
                                <option value="VENDEDOR4">Vendedor4</option>
                                <option value="VENDEDOR5">Vendedor5</option>
                                <option value="VENDEDOR6">Vendedor6</option>
                            </select>
                        </div>
