...
$mail->Subject = 'Factura de Exportacion'.$dte["dteJson"]["identificacion"]["codigoGeneracion"]; //Sets the Subject of the message
 $mail->Body    = 'Documento DTE Factura de exportacion';
 if($mail->Send()){
     echo "<script>document.getElementById('txtEstado').value= 'DTE : ".$dte["dteJson"]["identificacion"]["numeroControl"]." enviado con exito al Correo : ".$dte["dteJson"]["receptor"]["correo"]."';</script>";
 }else{
