...
class Cotizaciones extends Controller{
    ...
    public function listar()
    {
        ...
        for ($i=0; $i < count($data); $i++) { 
            ...
            $data[$i]['acciones'] = '<a class="btn btn-danger" href="#" onclick="verReporte(' . $data[$i]['id'] . ')"><i class="fas fa-file-pdf"></i></a> <a class="btn btn-warning" href="#" onclick="detalle(' . $data[$i]['id'] . ')"><i class="fas fa-file-edit"></i></a><a class="btn btn-success" href="#" onclick="verComentarios(' . $data[$i]['id'] . ')"><i class="fas fa-comments"></i></a>';            
        }
        echo json_encode($data, JSON_UNESCAPED_UNICODE);
        die();
    }
